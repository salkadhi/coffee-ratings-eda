...
```{r, echo=FALSE, eval=TRUE}
#The correlation between moisture and aroma
# library(ggplot2) 
# ggplot(Data ,aes(moisture,aroma))+
#   geom_col()

plot(moisture ~ aroma ,data = coffee_ratings , main="The relationship Between Moisture and Aroma" )
cor(coffee_ratings$moisture , coffee_ratings$aroma , use="complete.obs") #-0.1341272
```

```{r, echo=FALSE, eval=TRUE}
#The correlation between moisture and acidity
# library(ggplot2) 
# ggplot(Data ,aes(moisture,acidity))+
#   geom_col()

plot(moisture ~ acidity ,data = coffee_ratings , main="The relationship between  moisture and acidity"  )
cor(coffee_ratings$moisture , coffee_ratings$acidity , use="complete.obs") #-0.1290795
```
